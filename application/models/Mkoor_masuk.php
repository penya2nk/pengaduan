...
class Mkoor_masuk extends CI_Model
{
	public function pengaduan_masuk()
	{
		...
		$this->db->select('pl.id_pengaduan, p.wkt_pengaduan, k.kategori, r.nama_ruang');
	...
	{
		$this->db->select('p.id_pengaduan, p.deskripsi, p.kejadian, p.penyebab, p.tgl_kejadian, p.efek,  r.nama_ruang, p.keterangan, k.kategori, u.nama_pengguna, t.nama_tempat');	
