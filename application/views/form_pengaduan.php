    ...
    <div id="wrapper">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                  ...
                                                  <input type="date" class="form-control" data-mask="'alias': 'dd/mm/yyyy'" data-mask required="Wajib diisi">
                                                </div>
                                            </div>
                                        </div>
     ...
     <!--                                       <div class="form-group">
                                                ...
                                                <div class="input-group control-group after-add-more">
                                                  <input type="text" class="form-control" placeholder="Silahkan isi tindak lanjut">
                                                  <div class="input-group-btn"> 
                                                    <button class="btn btn-success add-more" type="button"><i class="fa fa-plus"></i> Tambah</button>
                                                  </div>
                                                </div>
                                                
                                                 Field copy yang dihidden 
                                                <div class="copy hide">
                                                  <div class="control-group input-group" style="margin-top:10px">
                                                    <input type="text" class="form-control" placeholder="Silahkan isi tindak lanjut">
                                                    <div class="input-group-btn"> 
                                                      <button class="btn btn-danger remove" type="button"><i class="fa fa-remove"></i> Hapus</button>
                                                    </div>
                                                  </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function add(){
        ...
        stre="<p id='srow "+ idf +"'><input type='text' class='form-control' placeholder='Bagaimana tindak lanjut Anda?' style='width: 70%'><a href='#' onclick='hapus(\"#srow "+idf+"\"); return false;'><span class='fa fa-close'>hapus</span></a></p>";
        $("#divAdd").append(stre);
             idf = (idf-1) + 2;
